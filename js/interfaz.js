                         ...
                         <div class="card">
                              ...
                              <div class="card-body">
                                   <div class="card-text">
                                        ...
                                        <p class="lead text-info">About the event:</p>
                                        <p>${evento.description.text.substring(0,280)}...</p>

                                        <span class="badge badge-primary">Availability: ${evento.capacity}</span>
                                        <span class="badge badge-secondary">date and hour: ${evento.start.local}</span>

                                        <a href="${evento.url}" target="_blank" class="btn btn-primary btn-block mt-4">Buy Tickets</a>  
                                   </div>
                              </div>
